...
public class AskQuote extends Fragment {
    ...
    private EditText generationdate,validtill,quantity,customersite,supplierID,price;
    Spinner quality;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        generationdate=(EditText)view.findViewById(R.id.start_date);
        ...
        supplierID=(EditText)view.findViewById(R.id.supplier_id);
    ...
    private void startPo(Result res1)
    {
        ...
        createPO(generationdate.getText().toString(),validtill.getText().toString(),quantity.getText().toString(),quality.getSelectedItem().toString(),customersite.getText().toString(),price.getText().toString(),supplierID.getText().toString(),res1);
    }

    private void createPO(String gen_date, String val_date, String quantity, String quality, String customer_site,String price,String supp_id,Result res1)
    {
